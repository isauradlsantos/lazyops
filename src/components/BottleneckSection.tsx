      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-black/50 backdrop-blur-sm rounded-3xl p-12 border border-white/10">
          <p className="text-2xl text-white/80 mb-12 leading-relaxed">
            High-potential companies stall when growth relies on inconsistent founder hustle 
            and one-off campaigns. Automation and tooling only work after:
          </p>
